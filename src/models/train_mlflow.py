...
ml_testing = MlflowExperiment(cfg['location']['today_data'],'version1',train_data,test_data, model,model_parameters,cfg['experiment_details']['name'], cfg['model_parameters']['problem_type'])
